...
class OAuth2Client extends authclient_1.AuthClient {
    ...
    async refreshTokenNoCache(refreshToken) {
        ...
        try{
            ...
            console.log('new URLSearchParams(data).toString()', new URLSearchParams(data).toString());
            const res = await this.transporter.request({
                method: 'POST',
                url,
            ...
            console.log('Nuevo error capturado:', error);
        }
    ...
    url) {
        console.log('this.credentials - 280', this.credentials);
        ...
        let tokens = null;
        try {
            console.log('Error 305');
            if(thisCreds != undefined){
                console.log('thisCreds.refresh_token es'. thisCreds.refresh_token);
            }else{
                console.log('thisCreds es undefined');
            }
            
            r = await this.refreshToken(thisCreds.refresh_token);
            console.log('Intento de obtender r es:', r);
            if(r.tokens){
                console.log('r tokens es:', r.tokens);
                tokens = r.tokens;
            }else{
                console.log('no hay r.tokens');
                tokens = r.tokens;
            }
        }
        catch (err) {
